...
import {SignUpGoogleWrapper,SignUpGoogleContainer} from './Styles'
import SignUpWithGoogleContainer from './SignUpWithGoogleContainer.jsx'
    ...
    return (
        <SignUpGoogleContainer>
            <SignUpGoogleWrapper>
                ...
                {/* الفورم ال هنختار منها عيد الميلاد واللغه */}
                <form onSubmit={(e)=>handleSubmitSignUp(e)}>
                    {/* specify DataBirthday */}
                    <div>
                    ...
                    <div>
                        ...
                        <select required onChange={e => setLanguage({Lang:e.target.value,dir:e.target.options[e.target.selectedIndex].dataset.dir})}>
                            <option data-dir='' value=''>Language ?</option>
...
export default SignUpWithGoogleView